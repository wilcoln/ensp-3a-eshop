...
public class VWhatsappController implements Initializable {
    ...
    public VBox createPage(int pageIndex) {
        ...
        for (int i = page; i < page + itemsPerPage(); i++) {
            ...
            table.setOnMousePressed(e -> {
                ...
                try {
                    Parent presentation = FXMLLoader.load(getClass().getResource("../../views/whatsapp/pWhatsapp.fxml"));
            ...
            btnAdd.setOnAction(event -> {
                Stage modal = new Stage(StageStyle.TRANSPARENT);
                try {
                    Parent presentation = FXMLLoader.load(getClass().getResource("../../views/whatsapp/aWhatsapp.fxml"));
                    Scene scene = new Scene(presentation);
                    scene.setFill(Color.TRANSPARENT);
                    modal.setScene(scene);
                    modal.show();
